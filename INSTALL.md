...
ShellHopper launches each selected environment as two Windows Terminal tabs: `<name>:nvim` for the configured editor command and `<name>:shell` for an interactive shell in the same workspace.
